...
<div class="hero-wrap hero-bread" style="background-image: url('images/mens_cloth.jpg');">
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-6 ftco-animate">
                <p class="breadcrumbs"><span class="mr-2"><a href="index.php" style="color: whitesmoke;">Home</a></span>
                <h1 class="mb-0 -align-center bread" style="color: whitesmoke;">Men's Clothing</h1>
            </div>
        </div>
    </div>
</div>
