...
<div class="hero-wrap hero-bread" style="background-image: url('images/womes_cloth.jpg');">
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-7 ftco-animate text-right">
                <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span>
                <h1 class="mb-0 bread">Women's Clothing</h1>
            </div>
        </div>
    </div>
</div>
...
<section class="ftco-section">
    <div class="container">
        <div class="row">
            ...
            $conn = openconnection();
            $query = 'select * from women_cloth';
            $response = $conn->query($query);
            $catagory = 'women_cloth';
            ...
            if ($response->num_rows > 0) {
                ...
                while($row = $response->fetch_assoc()) {
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="product" >
                            <a  class="img-prod" href="product_detail.php?id=<?= $row['id'] ?>&catagory=<?= $catagory ?>"><img style="height: 300px ;width: 300px;" class="img-fluid" src="
                        <?php
                                echo $row["image_path"];
                                ?>
